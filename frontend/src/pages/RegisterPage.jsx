...
const RegisterPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setErrors({});
            // Optional: Redirect to login or home page after a short delay
            setTimeout(() => {
        ...
        <div className="flex justify-center items-center min-h-screen bg-light-gray p-4 font-sans">
            <div className="flex bg-white rounded-2xl shadow-soft-lg w-full max-w-5xl overflow-hidden animate-fade-in-up">
                ...
                <div className="w-full lg:w-1/2 md:w-1/2 p-5">
                    <h1 className="text-2xl font-extrabold text-center text-gray-800 mb-1">Create your free account</h1>
                    <div className="flex items-center my-4">
                        <div className="flex-grow border-t border-gray-300"></div>
                        <span className="flex-shrink mx-4 text-gray-500 text-sm">Sign up with</span>
                        <div className="flex-grow border-t border-gray-300"></div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                className={`mt-1 block w-full px-4 py-2 border rounded-xl shadow-sm text-sm focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-primary-blue transition-all duration-200 ${errors.username ? 'border-red-500' : 'border-gray-300'}`}
                                required
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className={`mt-1 block w-full px-4 py-2 border rounded-xl shadow-sm text-sm focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-primary-blue transition-all duration-200 ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'}`}
                                required
                            />
                    ...
                    <div className="mt-5 text-center">
                        <p className="text-sm text-gray-600">
                            ...
                            <a href="/login" className="font-medium text-primary-blue hover:text-dark-blue transition-colors duration-200">
                                Log in
                            </a>
                        </p>
                    </div>
                ...
                <div className="hidden lg:block md:block w-1/2">
                    <img
                        ...
                        onError={(e) => { e.target.onerror = null; e.target.src = "https://placehold.co/1000x1200/f0f4f8/808696?text=Welcome+to+Our+Community"; }}
                    />
                </div>
            </div>
        </div>
